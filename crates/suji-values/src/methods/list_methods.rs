    ...
    match method {
        ...
        "filter" => {
            ...
            let call_fn = call_closure_fn.ok_or_else(|| RuntimeError::MethodError {
                message: "filter() requires closure evaluation support".to_string(),
            })?;
            if let Value::List(items) = receiver.get() {
                let closure = &args[0];
                let mut filtered = Vec::new();
                for item in items {
                    if eval_closure(call_fn, closure, vec![item.clone()], None)?.is_truthy() {
        ...
        "map" => {
            ...
            let call_fn = call_closure_fn.ok_or_else(|| RuntimeError::MethodError {
                message: "map() requires closure evaluation support".to_string(),
            })?;
            if let Value::List(items) = receiver.get() {
                let closure = &args[0];
                let mut mapped = Vec::new();
                for item in items {
                    mapped.push(eval_closure(call_fn, closure, vec![item.clone()], None)?);
                }
        ...
        "fold" => {
            ...
            let call_fn = call_closure_fn.ok_or_else(|| RuntimeError::MethodError {
                message: "fold() requires closure evaluation support".to_string(),
            })?;
            if let Value::List(items) = receiver.get() {
...
mod tests {
    ...
    fn test_list_sum() {
        ...
        let receiver = ValueRef::Immutable(&list);
        let result = call_list_method(None, receiver, "sum", vec![]).unwrap();
    ...
    fn test_list_product() {
        ...
        let receiver = ValueRef::Immutable(&list);
        let result = call_list_method(None, receiver, "product", vec![]).unwrap();
    ...
    fn test_list_sum_with_non_numbers() {
        ...
        let receiver = ValueRef::Immutable(&list);
        let result = call_list_method(None, receiver, "sum", vec![]);
    ...
    fn test_list_reverse() {
        ...
        let result = call_list_method(None, receiver, "reverse", vec![]).unwrap();
        ...
        let result2 = call_list_method(None, receiver2, "reverse", vec![]).unwrap();
    ...
    fn test_list_sort() {
        ...
        let result2 = call_list_method(None, receiver2, "sort", vec![]).unwrap();
        ...
        let result3 = call_list_method(None, receiver3, "sort", vec![]).unwrap();
    ...
    fn test_list_min() {
        ...
        let result = call_list_method(None, receiver, "min", vec![]).unwrap();
        ...
        let result2 = call_list_method(None, receiver2, "min", vec![]).unwrap();
    ...
    fn test_list_max() {
        ...
        let result = call_list_method(None, receiver, "max", vec![]).unwrap();
        ...
        let receiver2 = ValueRef::Immutable(&temps);
        let result2 = call_list_method(None, receiver2, "max", vec![]).unwrap();
    ...
    fn test_list_min_max_errors() {
        ...
        let min_result = call_list_method(None, receiver1, "min", vec![]);
        assert!(matches!(
            min_result,
        ...
        let max_result = call_list_method(None, receiver2, "max", vec![]);
        assert!(matches!(
            max_result,
            Err(RuntimeError::InvalidOperation { .. })
        ));
        ...
        let min_type_result = call_list_method(None, receiver3, "min", vec![]);
        assert!(matches!(
            min_type_result,
        ...
        let max_type_result = call_list_method(None, receiver4, "max", vec![]);
        assert!(matches!(
            max_type_result,
            Err(RuntimeError::TypeError { .. })
        ));
    ...
    fn test_list_first() {
        ...
        let result = call_list_method(None, receiver, "first", vec![]).unwrap();
        ...
        let result2 = call_list_method(None, receiver2, "first", vec![]).unwrap();
    ...
    fn test_list_last() {
        ...
        let result = call_list_method(None, receiver, "last", vec![]).unwrap();
        ...
        let receiver2 = ValueRef::Immutable(&numbers);
        let result2 = call_list_method(None, receiver2, "last", vec![]).unwrap();
    ...
    fn test_list_first_last_empty() {
        ...
        let receiver1 = ValueRef::Immutable(&empty_list);
        let first_result = call_list_method(None, receiver1, "first", vec![]).unwrap();
        assert_eq!(first_result, Value::Nil);

        // Test last() on empty list returns nil
        let receiver2 = ValueRef::Immutable(&empty_list);
        let last_result = call_list_method(None, receiver2, "last", vec![]).unwrap();
    ...
    fn test_list_to_string() {
        ...
        let result = call_list_method(None, receiver, "to_string", vec![]).unwrap();
        assert_eq!(result, Value::String("[1, test, true]".to_string()));

        // Test empty list
        let empty_list = Value::List(vec![]);
        let receiver2 = ValueRef::Immutable(&empty_list);
        let result2 = call_list_method(None, receiver2, "to_string", vec![]).unwrap();
    ...
    fn test_list_first_with_default() {
        ...
        let result3 = call_list_method(None, receiver3, "first", vec![]).unwrap();
    ...
    fn test_list_last_with_default() {
        ...
        // Test empty list without default returns nil
        let receiver3 = ValueRef::Immutable(&empty);
        let result3 = call_list_method(None, receiver3, "last", vec![]).unwrap();
        assert_eq!(result3, Value::Nil);
    }
    ...
    fn test_list_average() {
        ...
        let receiver = ValueRef::Immutable(&list);
        let result = call_list_method(None, receiver, "average", vec![]).unwrap();
        ...
        let result2 = call_list_method(None, receiver2, "average", vec![]).unwrap();
        assert_eq!(result2, Value::Number(DecimalNumber::from_i64(10)));

        // Test empty list
        let empty = Value::List(vec![]);
        let receiver3 = ValueRef::Immutable(&empty);
        let result3 = call_list_method(None, receiver3, "average", vec![]).unwrap();
        assert_eq!(result3, Value::Nil);
    }
    ...
    fn test_list_average_mixed_types() {
        ...
        let receiver = ValueRef::Immutable(&list);
        let result = call_list_method(None, receiver, "average", vec![]);
        assert!(matches!(result, Err(RuntimeError::TypeError { .. })));
    }
