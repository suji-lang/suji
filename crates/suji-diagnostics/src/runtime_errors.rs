...
fn error_code_for_variant(error: &RuntimeError) -> u32 {
...
fn parse_method_error_info(message: &str) -> Option<(String, String)> {
    use regex::Regex;
...
fn generate_category_suggestions(category: ErrorCategory, error: &RuntimeError) -> Vec<String> {
    match category {
