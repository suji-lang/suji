...
use suji_ast::{Expr, Literal, StringPart};
...
impl Parser {
    ...
    pub(crate) fn parse_tuple_or_grouping(&mut self) -> ParseResult<Expr> {
        ...
        if self.match_token(Token::Comma) {
            ...
            if self.match_token(Token::RightParen) {
                ...
                self.validate_no_control_flow_in_exprs(&elements, "tuple literals")?;
    ...
    fn parse_list(&mut self) -> ParseResult<Expr> {
        ...
        self.validate_no_control_flow_in_exprs(&elements, "list literals")?;
    ...
    pub(super) fn parse_map(&mut self) -> ParseResult<Expr> {
        ...
        self.validate_no_control_flow_in_map_pairs(&pairs)?;
    ...
    fn parse_string_template(&mut self) -> ParseResult<Expr> {
        ...
        self.validate_no_control_flow_in_string_parts(&parts, "string templates")?;
